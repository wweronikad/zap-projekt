...
# =============================================================================
# 11 PORÓWNANIE ZGODNOŚCI KLASYFIKACJI Z CLC 2018 i 2023
# =============================================================================
...
if (!is.na(accuracy_2018_clc) && !is.na(accuracy_2023_clc)) {
  ...
  else if (diff_clc < 0) print("Poogorszenie jakości klasyfikacji")
  else print("Brak zmian w jakości klasyfikacji")
}
